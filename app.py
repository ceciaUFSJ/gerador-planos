...
docente = st.text_area("Docente Responsável:", "João A. B. Cardoso")
coordenador = st.text_area("Coordenador do Curso:", "Mario C. D. Silva")
ano_oferecimento = st.text_area("Ano de Oferecimento:", str(ano_sugerido))
semestre_oferecimento = st.text_area("Semestre de Oferecimento:", semestre_sugerido)
